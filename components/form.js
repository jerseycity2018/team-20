...
export default class FormPage extends React.Component {
  ...
  onSubmit() {
    ...
    var newPostKey = db.collection('action').doc().set(postData)
...
render() {
  return (
    ...
    <
    Picker.Item label = "Recycle"
    value = "recycl" / >
    <
    Picker.Item label = "Donated Compost"
    value = "donate" / >
    <
    Picker.Item label = "Volunteer"
    value = "volunteer" / >
    <
    /Picker>
